                 ...
                 <form id="enquiryForm">
                     <div class="row g-3">
                         ...
                         <div class="col-md-6">
                             ...
                             <input type="text" class="form-control form-control-lg" id="enqName" placeholder="Enter your name" required>
                         </div>
                         <!-- Email -->
                         <div class="col-md-6">
                             <label for="enqEmail" class="form-label">Email</label>
                             <input type="email" class="form-control form-control-lg" id="enqEmail" placeholder="Enter your email" required>
                         </div>
                         <!-- Phone -->
                         <div class="col-md-6">
                             <label for="enqPhone" class="form-label">Phone</label>
                             <input type="tel" class="form-control form-control-lg" id="enqPhone" placeholder="Enter your phone" required>
                         </div>
                         <!-- Subject -->
                         <div class="col-md-6">
                             <label for="enqSubject" class="form-label">Subject</label>
                             <input type="text" class="form-control form-control-lg" id="enqSubject" placeholder="Subject of your enquiry" required>
                         </div>
                         <!-- Message -->
                         <div class="col-12">
                             <label for="enqMessage" class="form-label">Message</label>
                             <textarea class="form-control form-control-lg" id="enqMessage" rows="4" placeholder="Type your message here..." required></textarea>
                         </div>
                     </div>
